...
/******** OWNER NUMBER**********/
const ownerNumber = ["559992241284@s.whatsapp.net","559992241284@s.whatsapp.net"] 
/************************************/
...
break
		    ...
		    ow = "559992241284@s.whatsapp.net"
		    cuy = "559992241284@s.whatsapp.net"
                    menusu = `
❏ *GRUPO MENU*
│
└◪› ${prefix}welcome [1/0]
...
pp_riu = await getBuffer(pp_user)
		         ...
		         reply(`[❗] Olá ${pushname} aguarde⏳`)                 
					num = `${sender.split("@")[0]}@s.whatsapp.net`
		    ow = "55999224184@s.whatsapp.net"
		    cuy = "5599922184@s.whatsapp.net"
                    menusu = `
...
break
         	   ...
         	   case 'creator':
		    		...
		    		if (isLimit(sender)) return reply(ind.limitend(pusname))
			     	await limitAdd(sender)   	   
                  client.sendMessage(from, {displayname: "cychris", vcard: vcard}, MessageType.contact, { quoted: mek})
